...
One way of using the debug mode is setting your game display as window mode, and recording yourself playing while showing the console window, so you can see after playing all the notes and audio names.
